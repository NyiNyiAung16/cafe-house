...
<div class="min-h-screen min-w-screen bg-gray-800 py-10">
    <div class="createForm lg:max-w-4xl md:max-w-3xl sm:max-w-xl max-w-lg bg-slate-500 text-white grid grid-cols-12 gap-5 w-full">
